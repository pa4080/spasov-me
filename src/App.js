...
import cvPdf from "./assets/pdf/Spas_Zdravkov_Spasov_CV_2023_EN.pdf";
        ...
        <div className="mlt-pages">
          <Routes>
            <Route
              ...
              element={
                <Home
                  leadingText="by Spas Z. Spasov"
                  logoFull={mltLogoTextWide}
                  logoSmall={mltLogoTextSmall}
                />
              }
            />
            <Route
            ...
            <Route
              path="/about"
              element={<About data={data} aboutTitleImage={aboutTitleImage} />}
            />
            <Route
              path="/contacts"
              element={
            ...
            <Route
              path="*"
              element={<Error number="404" desc="Page not found" />}
            />
          </Routes>
        </div>
      </Router>
