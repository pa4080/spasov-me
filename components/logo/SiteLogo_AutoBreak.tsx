	...
	return (
		...
		>
			...
			>
				...
				/>
				<path
					className="logo-cls_mlt-blue-dark"
					...
					fill={fullConfig?.theme?.colors?.[textColor ?? "mlt-blue-dark"] as string}
				/>
			</svg>
			<p
			...
			>
				<span
					className={`${textColor ? textColorClass : "text-mlt-blue-dark"} logo-cls_mlt-blue-dark`}
				>
					{t("logoSubText.str0").substring(1)}
				</span>
				<span
					className={`absolute ${textBreakpoint}:contents right-0 ${textBreakpoint}:-bottom-[0.7em] ${textBreakpoint}:font-size-[0.7em] ${textBreakpoint}:transform-[translateY(0.3em)]`}
					style={{
