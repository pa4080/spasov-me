	...
	return (
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<DialogContent
				hideClose
				className={cn(
					"sm:max-w-full sm:max-h-full sm:rounded-none  sa:max-w-lg max-sa:h-full sa:max-h-[calc((var(--vh,1vh)_*_90))] sa:rounded-lg min-w-[320px] sa:min-w-[calc(100vw-6rem)] min-h-[calc(100vh-4rem)] flex flex-col gap-3 bg-background/60 sa:bg-background/20 sa:border-border/35 overflow-x-scroll 6xs:overflow-x-hidden",
					className
				)}
